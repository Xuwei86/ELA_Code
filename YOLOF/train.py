...
from tools import set_random_seed ,get_device
...
def parse_args():
    ...
    parser.add_argument('--save_folder', default='results/benchmark2', type=str,
    ...
    parser.add_argument('-v', '--version', default='yolof-r50',
                        choices=['yolof-r18', 'yolof-r50', 'yolof-r50-DC5', 'yolof-r101', 'yolof-r101-DC5', 'yolof-r50-RT','efficientrep'],
                        help='build yolof')
